#ifndef snare909short_H_
#define snare909short_H_
 
#include "Arduino.h"
#include <avr/pgmspace.h>
 
// stripped by 100 values: 2048 - 123 = 1925 cells
#define snare909short_NUM_CELLS 1925
#define snare909short_SAMPLERATE 16384
 
const int8_t __attribute__((progmem)) snare909short_DATA [] = {0, -1, 0, -1, 0, -1, 0,
